<?php
session_start();                     //using function and setting cookie
...
<?php if(isset($_POST["user"])&&isset($_POST["pass"]))
{
    if($_POST["user"]==USER && $_POST["pass"]==PASS)
    {
       ...
       setcookie("user",$_POST["user"],time()+7*24*60*60);        //time() gives current time in secounds adding 7 days in secounds
